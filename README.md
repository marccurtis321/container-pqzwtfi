...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pqzwtfi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pqzwtfi.containers.anotherwebservice.com/
...
```
git clone git@github.com:marccurtis321/container-pqzwtfi.git
cd container-pqzwtfi
```
...
```
docker attach container-pqzwtfi
```
